                    ...
                    if (branchName == 'master' || branchName == 'development') {
                        ...
                        container('jnlp') {
                            sshagent ( ['projects-storage.eclipse.org-bot-ssh']) {
                                ...
                                scp -r /home/jenkins/agent/workspace/e4z-explorer-for-zos_cicd-deploy/*zos*.vsix genie.che4z@projects-storage.eclipse.org:/home/data/httpd/download.eclipse.org/che4z/snapshots/$branchName
                                '''
                            }
                        }
